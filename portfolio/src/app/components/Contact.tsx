      ...
      <div className="contact-container">
        ...
        <div className="social-section">
          ...
          <div className="social-links">
            ...
            <Link href="https://www.instagram.com/baig_anousha/" target="_blank" rel="noopener noreferrer">
              <FaInstagram />
            </Link>
            <Link href="https://www.linkedin.com/in/anousha-baig-021a832b6/" target="_blank" rel="noopener noreferrer">
              <FaLinkedin />
            </Link>
            <Link href="https://github.com/AnoushaBaig" target="_blank" rel="noopener noreferrer">
              <FaGithub />
            </Link>
